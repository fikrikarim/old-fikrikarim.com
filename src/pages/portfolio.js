      ...
      <React.Fragment>
        ...
        <Layout location={this.props.location} title={siteTitle}>
          <main>
            ...
            <img src={kbri_2} />
            <p>
              The application fetchs the database of the guest from a Google
              Sheet, then shows it to see whether the card is correct or not.
            </p>
            <img src={kbri_3} />
            <p>
              We use Google Sheet as a database so admins can easily add and
              modify the database.
            </p>
            <img src={kbri_4} />
            <p>
              After confirming the information, admins click enter, and the
              entry is recorded to the event's sheet on the Google Sheet. Then
              the application is ready to scan the next guest.
            </p>
            <p>
              The project use React as the frontend framework, Redux as the
              state management, hosted at Firebase Hosting. Google Cloud
              Function as the FaaS backend for authentication and calling Google
              Sheet API. One cool thing is the project needs zero maintenance
              yayy.
            </p>
          </main>
          <Footer noMargin />
